...
api_key = 'f5ce12ff2d80c3ee2a0e8855166674fd'
...
class Application(tk.Frame):
	...
	def draw_widgets(self):
		# self.top
		self.app_label = tk.Label(self.top, text='Weather', font=('Algerian', 20, 'bold')
	...
	def get_weather(self, event=None):
		...
		if len(city) > 2:
			...
			try:
				...
				messagebox.showerror('WeatherApp', 'No such city in database')
			except:
				messagebox.showerror('WeatherApp', 'No internet Connection')
...
if __name__ == '__main__':
	...
	if not api_key:
		root.withdraw()
		messagebox.showerror('WeatherApp', 'OpenWeatherMap Api Key is required\n to use this App')
		sys.exit(0)
